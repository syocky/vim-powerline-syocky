...
let g:Powerline#Colorschemes#syocky#colorscheme = Pl#Colorscheme#Init([
  ...
  \ Pl#Hi#Segments(['fileinfo.flags'], {
    ...
    \ }),
  \
  \ Pl#Hi#Segments(['reanimate:load_point', 'currenttag', 'fullcurrenttag', 'fileformat', 'fileencoding', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup'], {
    \ 'n': ['gray8', 'gray2'],
